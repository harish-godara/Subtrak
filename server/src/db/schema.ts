...
export const subscriptions = pgTable('subscriptions', {
  ...
  billingCycle: varchar('billing_cycle', { length: 20 }).notNull().default('one-time'),
  ...
  renewals: jsonb('renewals').notNull().default([]),  // Renewal / plan-change history (RenewalRecord[])
